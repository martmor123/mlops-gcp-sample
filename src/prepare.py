from dvc import api #To replicate the terminal commands
import pandas as pd
from io import StringIO #When downloading files with the dvc api
import sys
import logging
...
#strings with the content from the files
movie_data_path = api.read('dataset/movies.csv', remote='dataset-track') #.dvc is already recognized
...
logger.info('Data Feteched and prepared...')